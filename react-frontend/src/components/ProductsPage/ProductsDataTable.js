...
<Column field="sku" header="Sku" body={pTemplate0} filter={selectedFilterFields.includes("sku")} hidden={selectedHideFields?.includes("sku")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="brand" header="Brand" body={pTemplate2} filter={selectedFilterFields.includes("brand")} hidden={selectedHideFields?.includes("brand")}  sortable style={{ minWidth: "8rem" }} />
